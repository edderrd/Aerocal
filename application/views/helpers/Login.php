...
class My_View_Helper_Login extends App_View_Helper_Abstract
{
	...
	public function login($attributes = array())
	{
        ...
        if (Zend_Auth::getInstance()->hasIdentity())
        {
            ...
            $message = "<a href='javascript:modalDialog(\"".$this->view->baseUrl("/user/index/format/json")."\");' title='$preferencesMsg'>{$identity->user['first_name']} {$identity->user['last_name']}</a> |";
